...
class QDataViewer(QtGui.QWidget):
	def __init__(self):
		...
		self.setWindowIcon(QtGui.QIcon('burger.png'))
	...
	# def run1_Phrase(self):
	#     subprocess.call(['autosub',self.filename])
	...
	def subtitle_gen(self):
		...
		def main():
			...
			args.source_path=str(args.source_path)
			audio_filename, audio_rate = extract_audio(args.source_path)
			print "audio file",audio_filename,audio_rate
